...
Contributors: marcofrasson, luizbills, marasca, amgnando
...
Confira o nosso guia de instalação e configuração na aba [Installation](http://wordpress.org/extend/plugins/woo-checkout-flow/installation/).
...
- A nossa sessão de [FAQ](http://wordpress.org/extend/plugins/woo-checkout-flow/faq/).
...
- Prevenir que o carrinho seja limpo em alguns casos específicos
