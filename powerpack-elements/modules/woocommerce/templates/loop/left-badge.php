...
if ( 'left' === $sale_badge_position ) {
	...
	<?php if ( $product->is_on_sale() ) : ?>
		...
		<?php echo wp_kses_post( apply_filters( 'pp_woo_products_sale_flash', '<div class="pp-left-badge-wrap"><span class="pp-left-badge pp-sale-badge">' . esc_html( $badge_text ) . '</span></div>', $post, $product ) ); ?>
...
if ( 'left' === $featured_badge_position ) {
	...
	if ( $product->is_featured() ) : ?>
		...
		<?php echo wp_kses_post( apply_filters( 'pp_woo_products_featured_flash', '<div class="pp-left-badge-wrap"><span class="pp-left-badge pp-featured-badge">' . esc_html( $badge_text ) . '</span></div>', $post, $product ) ); ?>
