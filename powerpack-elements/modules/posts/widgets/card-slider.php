...
class Card_Slider extends Posts_Base {
	 ...
	 * @access protected
	 */
	protected function render_image( $image_type, $item = '', $index ) {
		$settings = $this->get_settings();
	 ...
	 * @access protected
	 */
	protected function render_button( $item_type, $item = '', $index ) {
		$settings = $this->get_settings();
		...
		foreach ( $settings['items'] as $index => $item ) {
			...
			<div <?php echo wp_kses_post( $this->get_render_attribute_string( $item_key ) ); ?>>
				...
				if ( 'yes' === $item['card_image'] ) {
					$this->render_image( 'custom', $item, $index );
				}
				?>
				<div class="pp-card-slider-content-wrap">
					...
					<?php } ?>
					<?php $this->render_button( 'custom', $item, $index ); ?>
				</div>
			</div>
			<?php
			$i++;
