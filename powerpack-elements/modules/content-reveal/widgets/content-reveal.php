...
class Content_Reveal extends Powerpack_Widget {
	...
	protected function get_content_type() {
		...
		switch ( $content_type ) {
			...
			case 'section':
				$output = \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_section'] );
				break;

			case 'template':
				$output = \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['templates'] );
				break;

			case 'widget':
				$output = \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_widget'] );
				break;
	...
	protected function render() {
		...
		if ( 'pixels' === $settings['visible_type'] && $settings['visible_amount']['size'] ) {
					...
					<span class="pp-content-reveal-button pp-content-reveal-button-open">
						<span class="pp-content-reveal-button-content">
							<?php if ( $settings['icon_open'] ) { ?>
								<span class="pp-button-icon <?php echo esc_attr( $settings['icon_open'] ); ?>"></span>
							<?php } ?>
					...
					<span class="pp-content-reveal-button pp-content-reveal-button-closed">
						<span class="pp-content-reveal-button-content">
							<?php if ( $settings['icon_closed'] ) { ?>
								<span class="pp-button-icon <?php echo esc_attr( $settings['icon_closed'] ); ?>"></span>
							<?php } ?>
