	...
	protected function _register_controls() {
		...
		$this->__add_control(
			...
			array(
				...
				'type'   => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['instance'] . ' .tippy-popper[data-placement*=left] ' . $css_scheme['tooltip'] .' .tippy-arrow:before'=> 'border-left-color: {{VALUE}}',
					'{{WRAPPER}} ' . $css_scheme['instance'] . ' .tippy-popper[data-placement*=right] ' . $css_scheme['tooltip'] .' .tippy-arrow:before'=> 'border-right-color: {{VALUE}}',
					'{{WRAPPER}} ' . $css_scheme['instance'] . ' .tippy-popper[data-placement*=top] ' . $css_scheme['tooltip'] .' .tippy-arrow:before'=> 'border-top-color: {{VALUE}}',
					'{{WRAPPER}} ' . $css_scheme['instance'] . ' .tippy-popper[data-placement*=bottom] ' . $css_scheme['tooltip'] .' .tippy-arrow:before'=> 'border-bottom-color: {{VALUE}}',
				),
			),
			25
		);
