...
class Jet_Woo_Product_Gallery_Slider extends Jet_Woo_Product_Gallery_Base {
	...
	public function get_slider_data_settings() {
		...
		$slider_settings = array(
			...
			'thumbnails_columns_tablet'        => ! empty( $settings['pagination_thumbnails_columns_tablet'] ) ? $settings['pagination_thumbnails_columns_tablet'] : 2,
			'thumbnails_columns_mobile'        => ! empty( $settings['pagination_thumbnails_columns_mobile'] ) ? $settings['pagination_thumbnails_columns_mobile'] : 2,
