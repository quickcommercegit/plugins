...
class DM_plugin_update
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'http://mvpcopy.net/demo/dm/dynamic-menu-pro-update.php',
			'basename'	=>	plugin_basename( str_replace('dynamic-menu-pro.php', '.php', __FILE__) ),
			'slug'		=>	'dynamic-menu-pro/dynamic-menu.php'
		);
	...
	*/
	...
	function get_remote()
	{
        ...
        if( !is_wp_error($request) || wp_remote_retrieve_response_code($request) === 200)
        {
            ...
            //$info->slug = 'dynamic-menu-pro/dynamic-menu.php';//$this->settings['slug'];
        }
        
        /*echo '<pre>';
        print_r($this->settings['remote']);
		print_r($this->settings['slug']);die;*/
        return $info;
	}
	...
	*/
	...
	{	
        ...
        $obj = new stdClass();
        $obj->slug = 'dynamic-menu-pro/dynamic-menu.php';
    ...
    */
    ...
    function get_version()
    {
    	...
    	{
	    	$plugin_data = get_plugin_data( str_replace('dynamic-menu-pro.php', '.php', __FILE__) );
