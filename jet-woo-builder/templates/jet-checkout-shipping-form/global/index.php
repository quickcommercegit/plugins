...
$title    = $settings['checkout_shipping_form_title_text'];
			...
			<div class="woocommerce-shipping-fields">
				<h3 id="ship-to-different-address">
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
						...
						<span><?php echo ! empty( $title ) ? esc_html__( $title, 'jet-woo-builder' ) : esc_html__( 'Ship to a different address?', 'woocommerce' ); ?></span>
					</label>
				</h3>
