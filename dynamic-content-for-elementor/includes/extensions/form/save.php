...
class DCE_Extension_Form_Save extends \ElementorPro\Modules\Forms\Classes\Action_Base {
	...
	// first form action to be run , not sure why this is needed:
	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
				'dce_form_save_ignore_empty', [
					...
					'description' => __( 'Do not save the field if its value is empty to limit DB size consuption', 'dynamic-content-for-elementor' ),
				]
		);
		$widget->add_control(
				'dce_form_save_file', [
