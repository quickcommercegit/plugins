	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
				'dce_form_email_help', [
					...
					'raw' => '<div id="elementor-panel__editor__help" class="p-0"><a id="elementor-panel__editor__help__link" href="' . $this->doc_url . '" target="_blank">' . __( 'Need Help', 'elementor' ) . ' <i class="eicon-help-o"></i></a></div>',
					'separator' => 'before',
				]
		);
