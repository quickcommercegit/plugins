	...
	public function update_controls( $widget ) {
		...
		$field_controls = [
			...
			'dce_dynamic_select_options' => [
				...
				'default' => '',
				'description' => __( 'Options are written as a normal select field. They are grouped according to the reference field value with sections starting with this value inside square brackets: <code>[value]</code>.', 'elementor-pro' ),
				'condition' => [
					'field_type' => $this->get_type(),
				],
				'tab' => 'content',
