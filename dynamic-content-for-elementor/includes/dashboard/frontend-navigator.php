...
class FrontendNavigator {
	...
	public static function display_form() {
		...
		<form action="" method="post">
			...
			?>
			<?php $option = get_option( 'dce_frontend_navigator' ); ?>
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row">
						<div>
							<label for="frontend_navigator"><?php _e( 'Frontend Navigator', 'dynamic-content-for-elementor' ); ?></label>
						</div>
					</th>
					<td>
					<div>
					<select name="frontend_navigator">
						<option value="active" <?php if ( $option === 'active' ) {
							?>selected="selected"<?php } ?>><?php _e( 'Active only for administrators', 'dynamic-content-for-elementor' ); ?></option>
						<option value="active-visitors" <?php if ( $option === 'active-visitors' ) {
							?>selected="selected"<?php } ?>><?php _e( 'Active for all roles and visitors', 'dynamic-content-for-elementor' ); ?></option>
						<option value="inactive" <?php if ( $option === 'inactive' ) {
							?>selected="selected"<?php } ?>><?php _e( 'Inactive', 'dynamic-content-for-elementor' ); ?></option>
					</select>
				</div>
				</td>
				</tr>
