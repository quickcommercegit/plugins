...
return labels.join(', ')}}
const updateLabel=()=>{input.value=getLabel()};updateLabel();if(hiddenField){hiddenField.addEventListener('change',updateLabel)}else{alert(`Hidden Label, Could not find selector ${fieldId}`)}}
