...
define( 'WFSPB_F_VERSION', '1.1.4.5' );
...
//			add_action( 'wp_ajax_nopriv_wfspb_get_min_amount', array( $this, 'get_min_amount_updated_cart_totals' ) );
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox checked">
                                            <input type="checkbox"
                                                   ...
                                                   value="1">
                                            <label for="<?php echo self::set_field( 'enable' ); ?>"><?php esc_html_e( 'Enable', 'woo-free-shipping-bar' ) ?></label>
                                        </div>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox wfspb-enable-progress">
                                            <input type="checkbox"
                                                   ...
                                                   value="1">
                                            <label for="<?php echo self::set_field( 'enable-progress' ); ?>"><?php esc_html_e( 'Enable', 'woo-free-shipping-bar' ) ?></label>
                                        </div>
                                    </td>
                                </tr>
                                                ...
                                                <div class="field">
                                                    ...
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               ...
                                                               value="1">
                                                        <label for="<?php echo self::set_field( 'style' ); ?>"><?php esc_html_e( 'Style 1', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    ...
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               ...
                                                               value="2">
                                                        <label for="<?php echo self::set_field( 'style' ); ?>"><?php esc_html_e( 'Style 2', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    ...
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               ...
                                                               value="3">
                                                        <label for="<?php echo self::set_field( 'style' ); ?>"><?php esc_html_e( 'Style 3', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="field">
                                                    ...
                                                    <div class="vi-ui toggle checkbox checked center aligned segment">
                                                        <input type="radio"
                                                               ...
                                                               value="0">
                                                        <label for="<?php echo self::set_field( 'position' ); ?>"><?php esc_html_e( 'Top', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                                <div class="field">
                                                    ...
                                                    <div class="vi-ui toggle checkbox center aligned segment">
                                                        <input type="radio"
                                                               ...
                                                               value="1">
                                                        <label for="<?php echo self::set_field( 'position' ); ?>"><?php esc_html_e( 'Bottom', 'woo-free-shipping-bar' ) ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
										...
										foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo( self::set_field( 'announce-system' ) . '[' . $lang_code . ']' ); ?>"><?php echo trim( strip_tags( self::get_message_field( 'announce-system', $lang_code, 'Free shipping for billing over {min_amount}' ) ) ); ?></textarea>
											<?php
										} ?>
                                    ...
                                    <td class="wfspb-notice-sample">
                                        <div class="field">
											...
											foreach ( $langs as $lang_code => $lang_opttion ) {
                                                ...
                                                <textarea rows="2"
                                                          name="<?php echo( self::set_field( 'message-purchased' ) . '[' . $lang_code . ']' ); ?>"><?php echo trim( strip_tags( self::get_message_field( 'message-purchased', $lang_code, 'You have purchased {total_amounts} of {min_amount}' ) ) ); ?></textarea>
												<?php
											} ?>
                                            <ul class="description" style="list-style: none">
                                                <li>
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
										...
										foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo( self::set_field( 'message-success' ) . '[' . $lang_code . ']' ); ?>"><?php echo trim( strip_tags( self::get_message_field( 'message-success', $lang_code, 'Congratulation! You have got free shipping. Go to {checkout_page}' ) ) ); ?></textarea>
											<?php
										} ?>
                                        <ul class="description" style="list-style: none">
                                            <li>
                                ...
                                <tr valign="top">
                                    ...
                                    <td class="wfspb-notice-sample">
										...
										foreach ( $langs as $lang_code => $lang_opttion ) {
                                            ...
                                            <textarea rows="2"
                                                      name="<?php echo( self::set_field( 'message-error' ) . '[' . $lang_code . ']' ); ?>"><?php echo trim( strip_tags( self::get_message_field( 'message-error', $lang_code, 'You are missing {missing_amount} to get Free Shipping. Continue {shopping}' ) ) ); ?></textarea>
											<?php
										} ?>
                                        <ul class="description" style="list-style: none">
                                            <li>
                                    ...
                                    <td>
                                        <div class="vi-ui toggle checkbox checked">
                                            <input type="hidden" name="<?php echo self::set_field( 'show-giftbox' ); ?>"
                                                   value="0"/>
                                            <input type="checkbox"
                                                   name="<?php echo self::set_field( 'show-giftbox' ); ?>" <?php checked( self::get_field( 'show-giftbox', 1 ), 1 ); ?>
                                                   value="1"/>
		...
		public function create_options_page() {
			add_menu_page(
				__( 'Free Shipping Bar for WooCommerce', 'woo-free-shipping-bar' ),
				...
				if ( is_array( $shipping_methods ) && count( $shipping_methods ) ) {
					foreach ( $shipping_methods as $free_shipping ) {
						if ( $free_shipping->id == 'free_shipping' ) {
							...
							echo "<option value='" . $zone_id . "' " . selected( self::get_field( 'default-zone', $zone_id ), $zone_id ) . " >" . esc_html__( $zone_name ) . "</option>";
						} else {
							echo '';
						}
					}
