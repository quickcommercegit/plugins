				...
				if ( $(this).data('piotnetforms-stripe-submit') != undefined ) {
					...
					$fields.each(function(){
						if ( $(this).data('piotnetforms-stripe') == undefined && $(this).data('piotnetforms-html') == undefined ) {
							...
							if ( !isValid && $(this).closest('.piotnetforms-conditional-logic-hidden').length == 0 && $(this).closest('[data-piotnetforms-conditional-logic]').css('display') != 'none' &&  $(this).closest('[data-piotnetforms-signature]').length == 0 ) {
