		...
		global $wpdb;
			if ( !empty($_POST['post_id']) && !empty($_POST['form_id']) && !empty($_POST['fields']) ) {
				...
				if (in_array('hubspot', $form['settings']['submit_actions'])) {
					...
					if ( !empty($form['settings']['piotnetforms_hubspot_first_name']) ) {
						$piotnetforms_hubspot_first_name = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_first_name'], $fields);
						if ( !empty($piotnetforms_hubspot_first_name) ) {
							$hubspot_data['properties'][] = [
								'property' => 'firstname',
								'value' => $piotnetforms_hubspot_first_name,
							];
						}
					}

					if ( !empty($form['settings']['piotnetforms_hubspot_last_name']) ) {
						$piotnetforms_hubspot_last_name = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_last_name'], $fields);
						if ( !empty($piotnetforms_hubspot_last_name) ) {
							$hubspot_data['properties'][] = [
								'property' => 'lastname',
								'value' => $piotnetforms_hubspot_last_name,
							];
						}
					}

					if ( !empty($form['settings']['piotnetforms_hubspot_email']) ) {
						$piotnetforms_hubspot_email = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_email'], $fields);
						if ( !empty($piotnetforms_hubspot_email) ) {
							$hubspot_data['properties'][] = [
								'property' => 'email',
								'value' => $piotnetforms_hubspot_email,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_phone']) ) {
						$piotnetforms_hubspot_phone = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_phone'], $fields);
						if ( !empty($piotnetforms_hubspot_phone) ) {
							$hubspot_data['properties'][] = [
								'property' => 'phone',
								'value' => $piotnetforms_hubspot_phone,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_website']) ) {
						$piotnetforms_hubspot_website = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_website'], $fields);
						if ( !empty($piotnetforms_hubspot_website) ) {
							$hubspot_data['properties'][] = [
								'property' => 'website',
								'value' => $piotnetforms_hubspot_website,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_city']) ) {
						$piotnetforms_hubspot_city = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_city'], $fields);
						if ( !empty($piotnetforms_hubspot_city) ) {
							$hubspot_data['properties'][] = [
								'property' => 'city',
								'value' => $piotnetforms_hubspot_city,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_company']) ) {
						$piotnetforms_hubspot_company = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_company'], $fields);
						if ( !empty($piotnetforms_hubspot_company) ) {
							$hubspot_data['properties'][] = [
								'property' => 'company',
								'value' => $piotnetforms_hubspot_company,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_address']) ) {
						$piotnetforms_hubspot_address = replace_email($form['settings']['piotnetforms_hubspot_address'], $fields);
						if ( !empty($pafe_hubspot_address) ) {
							$hubspot_data['properties'][] = [
								'property' => 'address',
								'value' => $piotnetforms_hubspot_address,
							];
						}
					}

					if ( !empty($form['settings']['piotnetforms_hubspot_zip']) ) {
						$piotnetforms_hubspot_zip = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_zip'], $fields);
						if ( !empty($piotnetforms_hubspot_zip) ) {
							$hubspot_data['properties'][] = [
								'property' => 'zip',
								'value' => $piotnetforms_hubspot_zip,
							];
						}
					}
					if ( !empty($form['settings']['piotnetforms_hubspot_state']) ) {
						$piotnetforms_hubspot_state = replace_email_piotnetforms($form['settings']['piotnetforms_hubspot_state'], $fields);
						if ( !empty($piotnetforms_hubspot_state) ) {
							$hubspot_data['properties'][] = [
								'property' => 'state',
								'value' => $piotnetforms_hubspot_state,
							];
						}
					}
