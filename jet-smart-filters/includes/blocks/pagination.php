	...
	public function set_css_scheme(){
		...
		public function add_style_manager_options(){
			...
			$this->controls_manager->add_control([
				...
				'label'        => esc_html__( 'Border Color', 'jet-smart-filters' ),
				'css_selector' => array(
					'{{WRAPPER}} ' . $this->css_scheme['pagination-dots'] => 'border-color: {{VALUE}};',
				),
			]);
			$this->controls_manager->end_tab();
			...
			$this->controls_manager->add_control([
				...
				'separator'    => 'none',
				'css_selector' => [
					'{{WRAPPER}} ' . $this->css_scheme['pagination-item'] => 'margin-bottom: {{VALUE}}{{UNIT}}',
					'{{WRAPPER}} ' . $this->css_scheme['pagination']      => 'margin-bottom: -{{VALUE}}{{UNIT}}',
				],
				'attributes' => [
					'default' => [
						'value' => 4,
